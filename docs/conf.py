...
copyright = '2017, Zope Foundation and Contributors'
...
man_pages = [
    ('index', 'zpt', 'zope.pagetemplate Documentation',
...
texinfo_documents = [
  ('index', 'zpt', 'Page Template Documentation',
   'Zope Foundation and Contributors', 'zpt', 'One line description of project.',
   'Miscellaneous'),
]
